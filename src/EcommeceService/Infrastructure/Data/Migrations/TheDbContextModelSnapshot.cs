            ...
            modelBuilder.Entity("Domain.Aggregates.Services.ServiceResource", b =>
                {
                    ...
                    b.HasIndex("BranchProductId")
                        .HasDatabaseName("ix_service_resource_branch_product_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.Tariffs.Tariff", "Tariff")
                        ...
                        .HasConstraintName("fk_order_tariff_tariff_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Orders.OrderEquipment", b =>
                {
                    b.HasOne("Domain.Aggregates.Equipments.Equipment", "Equipment")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_equipment_equipment_equipment_id");
                    ...
                    b.HasOne("Domain.Aggregates.Orders.Order", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_equipment_order_order_id");
            ...
            modelBuilder.Entity("Domain.Aggregates.Services.ServiceResource", b =>
                {
                    b.HasOne("Domain.Aggregates.Products.BranchProduct", "BranchProduct")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_resource_branch_product_branch_product_id");

                    b.HasOne("Domain.Aggregates.Services.UnitRelation", "UnitProduct")
                        .WithMany("AsUnitProduct")
                        .HasForeignKey("UnitProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_resource_unit_relation_unit_product_id");

                    b.HasOne("Domain.Aggregates.Services.UnitRelation", "UnitRelation")
                        .WithMany("AsUnitRelation")
                        .HasForeignKey("UnitRelationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_resource_unit_relation_unit_relation_id");
